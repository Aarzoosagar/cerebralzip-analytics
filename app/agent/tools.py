...
TOOL_DEFINITIONS = [
    ...
    {"type": "function", "function": {"name": "review_analysis", "description": "Review score distribution with explicit 1-5 buckets, averages by optional day/month/year period or customer state, category/seller scores, or response time in hours.", "parameters": {"type": "object", "properties": {"metric": {"type": "string", "enum": ["distribution", "average", "category", "seller", "response_time"]}, "category": {"type": ["string", "null"]}, "seller_id": {"type": ["string", "null"]}, "state": {"type": ["string", "null"]}, "group_by_state": {"type": "boolean"}, "from_date": {"type": ["string", "null"]}, "to_date": {"type": ["string", "null"]}, "limit": {"type": "integer", "minimum": 1, "maximum": 100}, "sort": {"type": "string", "enum": ["asc", "desc"]}, "granularity": {"type": ["string", "null"], "enum": ["day", "month", "year", None]}}, "required": []}}},
    {"type": "function", "function": {"name": "payment_breakdown", "description": "Payment value, transaction share, payment-value share, installments, or monthly payment value by data-driven payment type.", "parameters": {"type": "object", "properties": {"metric": {"type": "string", "enum": ["value_by_type", "transaction_share", "value_share", "installments", "value_by_period"]}, "from_date": {"type": ["string", "null"]}, "to_date": {"type": ["string", "null"]}, "payment_types": {"type": ["array", "null"], "items": {"type": "string", "enum": ["credit_card", "boleto", "voucher", "debit_card", "not_defined"]}}}, "required": []}}},
